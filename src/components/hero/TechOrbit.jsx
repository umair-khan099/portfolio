...
const techData = [
  {
    ...
    name: "JavaScript",
    color: "#F7DF1E",
    glowColor: "radial-gradient(circle, rgba(247,223,30,0.65) 0%, rgba(247,223,30,0.15) 50%, transparent 80%)",
    pos: { top: "3%", left: "50%", transform: "translateX(-50%)" },
    float: { y: -14, rotate: 3, scale: 1.04, duration: 3.4, delay: 0 },
    icon: () => (
      <svg viewBox="0 0 24 24" className="w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8 shrink-0" fill="none">
  ...
  },
  {
    ...
    name: "React",
    color: "#61DAFB",
    glowColor: "radial-gradient(circle, rgba(97,218,251,0.65) 0%, rgba(97,218,251,0.15) 50%, transparent 80%)",
    pos: { top: "21%", left: "1%" },
    float: { y: 16, rotate: -4, scale: 1.05, duration: 4.1, delay: 0.3 },
    icon: () => (
      <svg viewBox="0 0 24 24" className="w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8 shrink-0" fill="none">
        <ellipse cx="12" cy="12" rx="10" ry="4.5" stroke="#61DAFB" strokeWidth="1.8" />
        <ellipse cx="12" cy="12" rx="10" ry="4.5" stroke="#61DAFB" strokeWidth="1.8" transform="rotate(60 12 12)" />
        <ellipse cx="12" cy="12" rx="10" ry="4.5" stroke="#61DAFB" strokeWidth="1.8" transform="rotate(120 12 12)" />
  ...
  },
  {
    ...
    name: "Node.js",
    color: "#5FA04E",
    glowColor: "radial-gradient(circle, rgba(95,160,78,0.65) 0%, rgba(95,160,78,0.15) 50%, transparent 80%)",
    pos: { top: "23%", right: "1%" },
  ...
  },
  {
    ...
    name: "Express",
    color: "#FFFFFF",
    glowColor: "radial-gradient(circle, rgba(255,255,255,0.6) 0%, rgba(255,255,255,0.12) 50%, transparent 80%)",
    pos: { top: "63%", left: "2%" },
  ...
  },
  {
    ...
    name: "MongoDB",
    color: "#47A248",
    glowColor: "radial-gradient(circle, rgba(71,162,72,0.65) 0%, rgba(71,162,72,0.15) 50%, transparent 80%)",
    pos: { top: "65%", right: "2%" },
    ...
    icon: () => (
      <svg viewBox="0 0 24 24" className="w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8 shrink-0" fill="none">
        <path
          ...
          strokeWidth="1.8"
        />
        <path d="M12 2v20" stroke="#47A248" strokeWidth="1.4" strokeLinecap="round" />
      </svg>
    ),
  },
  {
    ...
    name: "PostgreSQL",
    color: "#4169E1",
    glowColor: "radial-gradient(circle, rgba(65,105,225,0.65) 0%, rgba(65,105,225,0.15) 50%, transparent 80%)",
    pos: { top: "86%", left: "50%", transform: "translateX(-50%)" },
    ...
    icon: () => (
      <svg viewBox="0 0 24 24" className="w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8 shrink-0" fill="none">
        ...
        <path d="M13 10c1 0 2.5.5 3 2" stroke="#4169E1" strokeWidth="1.4" strokeLinecap="round" />
      </svg>
    ),
  },
];
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      icons.forEach((icon, i) => {
        const spec = techData[i]?.float || { y: -14, rotate: 3, scale: 1.04, duration: 3.6, delay: 0 };
        gsap.to(icon, {
          y: spec.y,
          rotate: spec.rotate,
          scale: spec.scale,
